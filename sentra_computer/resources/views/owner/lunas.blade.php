...
<head>
    ...
    <title>Lunas Owner</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" href="../css/stylelunas.css">
</head>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{route('owner.lunas')}}" class="menu-item active">
    ...
    <header class="header">
     ...
     <main>
        ...
        <div class="search-container">
            ...
            <form action="{{ route('owner.lunas') }}" method="GET" class="flex-grow">
