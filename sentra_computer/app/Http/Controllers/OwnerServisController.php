...
class OwnerServisController extends Controller
{
    public function store(Request $request)
    {
        ...
        return redirect()->route('owner.daftarservis')->with('success', 'Data servis berhasil disimpan!');
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('owner.daftarservis', [
            'servis' => $servis,
    ...
    public function showDetail($id_tracking)
    {
        ...
        return view('owner.detail', compact('servis'));
    }
